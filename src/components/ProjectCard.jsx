    ...
    return (
        <div className='hover:-mt-4 duration-300 cursor-pointer'>
            <div className='p-2 bg-gradient-to-tr from-blue-500 to-teal-400 rounded-2xl'>
                <img src={img} className='inlnie-block rounded-xl' />
                <div className='p-8'>
                        ...
                        <div className='flex flex-col lg:flex-row '>
                            <div className='w-36 -mb-2'>
                                <a
                                    href={live}
                                    target='_blank'
                                    className='group text-xl mt-4 border-b inline-block duration-300 text-black border-zinc-600 hover:border-white'
                                >
                                    Live Link
